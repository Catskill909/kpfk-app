...
class ServiceRegistry {
  static KPFKAudioHandler? _audioHandler;
  ...
  static T get<T>() {
    if (T == KPFKAudioHandler) return _audioHandler as T;
...
Future<void> setupServiceLocator() async {
  ...
  final audioHandler = await KPFKAudioHandler.create();
  ...
  ServiceRegistry._streamRepository = StreamRepository(
    audioHandler: ServiceRegistry.get<KPFKAudioHandler>(),
