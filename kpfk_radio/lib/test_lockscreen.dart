...
class _LockscreenTestScreenState extends State<LockscreenTestScreen> {
  ...
  final TextEditingController _albumController =
      TextEditingController(text: 'KPFK 90.7 FM');

  // Direct native channel - CRITICAL: Must match AppDelegate.swift
  static const MethodChannel _channel =
      MethodChannel('com.kpfkfm.radio/now_playing');
  ...
  Future<void> _initAudio() async {
    try {
      // Initialize audio source with KPFK stream URL
      await _player.setUrl('https://kpfk.streamguys1.com/live');
  ...
  Future<void> _updateLockscreen() async {
    ...
    try {
      ...
      final Map<String, dynamic> metadata = {
        ...
        'album': album,
        'artworkUrl':
            'https://confessor.kpfk.org/playlist/images/kpfk_logo.png',
        'isPlaying': true,
      };
