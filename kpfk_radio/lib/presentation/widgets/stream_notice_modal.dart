...
class StreamNoticeModal extends StatelessWidget {
  ...
  // KPFK is a dark-only app; style the card for dark surfaces.
  static const Color _accent = Color(0xFFE53935); // KPFK brand red
  static const Color _card = Color(0xFF1C1413);
  static const Color _ink = Colors.white;

  bool get _isOutage => notice.kind == StreamNoticeKind.outage;

  IconData get _icon => _isOutage
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Icon(_icon, color: _accent, size: 36),
                  ),
