...
class MainActivity: FlutterActivity() {
    ...
    companion object {
        private const val CHANNEL = "app.pacifica.kpfk/samsung_media_session"
    }
    ...
    private fun ensureAudioChannelNoBadge() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                ...
                val channelId = "com.kpfkfm.radio.audio" // must match AudioService.init config
                ...
                if (existing != null) {
                    ...
                    val ch = NotificationChannel(
                        ...
                        description = "KPFK Radio Audio Playback"
                        setShowBadge(false)
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        methodChannel?.setMethodCallHandler { call, result ->
            when (call.method) {
                "updateMetadata" -> {
                    val title = call.argument<String>("title") ?: "KPFK 90.7 FM"
