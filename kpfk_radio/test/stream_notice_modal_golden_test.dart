...
import 'package:kpfk_radio/presentation/widgets/stream_notice_modal.dart';
...
void main() {
  ...
  Widget harness(StreamNotice notice) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Stack(
          children: [
            const Center(
              child: Icon(Icons.radio, size: 160, color: Colors.white24),
            ),
            StreamNoticeModal(
              notice: notice,
              onDismiss: () {},
