...
/// chasing the ~2.5s iOS lock-screen Now Playing flash added a "resume in
/// place" fast path that skips rebuilding the AudioSource. That fast path
...
void main() {
  ...
  setUpAll(() {
    final file = File('lib/services/audio_service/kpfk_audio_handler.dart');
