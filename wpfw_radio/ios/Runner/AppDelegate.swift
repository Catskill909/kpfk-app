...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    private func setupDefaultMetadata() {
        let nowPlayingInfo: [String: Any] = [
            MPMediaItemPropertyTitle: "WPFW 89.3 FM",
            MPMediaItemPropertyArtist: "Jazz and Justice Radio",
            MPMediaItemPropertyAlbumTitle: "WPFW",
    ...
    override func application(
        ...
        metadataChannel = FlutterMethodChannel(name: "com.wpfwfm.radio/metadata",
                                            binaryMessenger: controller.binaryMessenger)
        
        // 4b. Set up NOW PLAYING channel for IOSLockscreenService
        let nowPlayingChannel = FlutterMethodChannel(name: "com.wpfwfm.radio/now_playing",
                                                   binaryMessenger: controller.binaryMessenger)
    ...
    private func handleUpdateNowPlaying(call: FlutterMethodCall, result: FlutterResult) {
        ...
        let album = args["album"] as? String ?? "WPFW 89.3 FM"
