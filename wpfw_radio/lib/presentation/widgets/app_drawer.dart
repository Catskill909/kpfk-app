...
class AppDrawer extends StatelessWidget {
  ...
  Widget _buildSocialIcons(BuildContext context) {
    ...
    final iconSize = isSmallPhone ? 20.0 : 28.0;  // Smaller icons for small devices
    final horizontalPadding = isSmallPhone ? 12.0 : 24.0;
    final verticalPadding = isSmallPhone ? 6.0 : 16.0;  // Much less vertical padding
  ...
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;
    final isSmallPhone = size.shortestSide < 380;
    final headerPadding = isSmallPhone ? 4.0 : 16.0;  // Much smaller padding for small devices
    final iconSize = isSmallPhone ? 20.0 : 28.0;
    final listTileHorizontalPadding = isSmallPhone ? 12.0 : 24.0;
    final listTileVerticalPadding = isSmallPhone ? 1.0 : 8.0;  // Drastically reduce vertical spacing
    ...
    return Drawer(
      child: Container(
        ...
        child: Column(
          children: [
            Container(
              height: isSmallPhone ? 60.0 : null,  // Even smaller header for small devices
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      title: Text(
                        'Home',
                        style: AppTextStyles.drawerMenuItemForDevice(size).copyWith(
                          fontSize: isSmallPhone ? 13.0 : 18.0,  // Even smaller font for small devices
                        ),
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                      ),
                      contentPadding: EdgeInsets.symmetric(
                          horizontal: listTileHorizontalPadding, vertical: listTileVerticalPadding),
                      onTap: () {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: isSmallPhone ? 4.0 : 16.0), // Minimal bottom padding for small devices
                ],
              ),
            ),
          ],
