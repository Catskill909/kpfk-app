...
class _SleepTimerViewState extends State<_SleepTimerView>
  ...
  Widget build(BuildContext context) {
    ...
    const accent = Color(0xFFE53935); // WPFW red-ish accent
    return Material(
            ...
            child: Container(
              ...
              child: BlocConsumer<SleepTimerCubit, SleepTimerState>(
                ...
                builder: (context, state) {
                  ...
                  final isBeforeStart = state is SleepTimerInactive || state is SleepTimerScheduled;
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      _TimerRing(remaining: remaining, total: total, accent: accent),
                      const SizedBox(height: 16),
                      _PresetRow(
                        onSelect: (m) => context.read<SleepTimerCubit>().setMinutes(m),
                      ...
                      _MinutesSlider(
                        ...
                        onChanged: (v) =>
                            context.read<SleepTimerCubit>().setMinutes(v.round()),
                        disabled: isRunning || isPaused,
                        accent: accent,
                      ),
                      const SizedBox(height: 16),
...
class _TimerRing extends StatelessWidget {
  ...
  final Color accent;
  const _TimerRing({required this.remaining, required this.total, required this.accent});
            ...
            children: [
              ...
              Text('$h:${two(m)}:${two(s)}',
                  style: Theme.of(context)
                      .textTheme
                      .headlineSmall
                      ?.copyWith(fontFeatures: const [], fontWeight: FontWeight.bold)),
            ],
          ),
        ),
      ],
