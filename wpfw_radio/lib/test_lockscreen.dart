...
class _LockscreenTestScreenState extends State<LockscreenTestScreen> {
  final TextEditingController _titleController = TextEditingController(text: 'Community Watch & Comment');
  final TextEditingController _artistController = TextEditingController(text: 'Host: David Rabin');
  final TextEditingController _albumController = TextEditingController(text: 'WPFW 89.3 FM');
  ...
  Future<void> _initAudio() async {
    try {
      // Initialize audio source with WPFW stream URL
      await _player.setUrl('https://wpfw.streamguys1.com/live');
  ...
  Future<void> _updateLockscreen() async {
    ...
    try {
      ...
      final Map<String, dynamic> metadata = {
        ...
        'artist': artist,
        'album': album,
        'artworkUrl': 'https://wpfwfm.org/radio/wp-content/uploads/2021/04/WPFW-Logo-1.png',
        'isPlaying': true,
      };
