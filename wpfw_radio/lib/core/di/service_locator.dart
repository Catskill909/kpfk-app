...
class ServiceRegistry {
  static WPFWAudioHandler? _audioHandler;
  ...
  static T get<T>() {
    if (T == WPFWAudioHandler) return _audioHandler as T;
...
Future<void> setupServiceLocator() async {
  ...
  final audioHandler = await WPFWAudioHandler.create();
  ...
  ServiceRegistry._streamRepository = StreamRepository(
    audioHandler: ServiceRegistry.get<WPFWAudioHandler>(),
