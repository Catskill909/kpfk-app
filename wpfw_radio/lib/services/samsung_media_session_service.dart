...
class SamsungMediaSessionService {
  static const MethodChannel _channel = MethodChannel('app.pacifica.wpfw/samsung_media_session');
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      LoggerService.error('🤖 SAMSUNG: Failed to initialize MediaSession service: $e');
    }
  }
    ...
    switch (call.method) {
      case 'onMediaAction':
        ...
        try {
          ...
          switch (action) {
            case 'play':
              LoggerService.info('🤖 SAMSUNG: Play action received from lockscreen - calling StreamRepository.play()');
              await streamRepository.play(source: AudioCommandSource.lockscreen);
              break;
            case 'pause':
              LoggerService.info('🤖 SAMSUNG: Pause action received from lockscreen - calling StreamRepository.pause()');
              await streamRepository.pause(source: AudioCommandSource.lockscreen);
              break;
            case 'stop':
              LoggerService.info('🤖 SAMSUNG: Stop action received from lockscreen - calling StreamRepository.pause()');
              await streamRepository.pause(source: AudioCommandSource.lockscreen);
              break;
          }
        } catch (e) {
          LoggerService.error('🤖 SAMSUNG: Failed to handle media action $action: $e');
        }
        break;
      case 'onAppClosing':
        ...
        try {
          LoggerService.info('🤖 SAMSUNG: onAppClosing received - stopping and clearing player');
  ...
  static Future<void> updateMetadata(String title, String artist) async {
    ...
    try {
      ...
      LoggerService.info('🤖 SAMSUNG: Updated metadata - Title: $title, Artist: $artist');
    } catch (e) {
  ...
  static Future<void> updatePlaybackState(bool isPlaying) async {
    ...
    try {
      ...
      LoggerService.info('🤖 SAMSUNG: Updated playback state - Playing: $isPlaying');
    } catch (e) {
