...
import 'package:wpfw_radio/services/audio_service/wpfw_audio_handler.dart';
        ...
        switch (call.method) {
          case 'remotePlay':
            ...
            try {
              ...
              LoggerService.info('🔒 REMOTE COMMAND: Play executed through StreamRepository');
            } catch (e) {
          ...
          case 'remotePause':
            ...
            try {
              ...
              LoggerService.info('🔒 REMOTE COMMAND: Pause executed through StreamRepository');
            } catch (e) {
          ...
          case 'remoteTogglePlayPause':
            ...
            try {
              ...
              if (currentState == StreamState.playing) {
                await streamRepository.pause(source: AudioCommandSource.lockscreen);
                LoggerService.info('🔒 REMOTE COMMAND: Toggle -> Pause executed through StreamRepository');
              } else {
                await streamRepository.play(source: AudioCommandSource.lockscreen);
                LoggerService.info('🔒 REMOTE COMMAND: Toggle -> Play executed through StreamRepository');
              }
            } catch (e) {
  ...
  Future<bool> updateLockscreenMetadata({
    ...
    try {
      ...
      if (artworkUrl != null && artworkUrl.isNotEmpty) {
        ...
        LoggerService.info('🔒 NATIVE: No artwork URL provided (artworkUrl: $artworkUrl)');
      }

      // Log the complete metadata being sent
      LoggerService.info('🔒 NATIVE: Sending complete metadata to iOS: $metadata');
