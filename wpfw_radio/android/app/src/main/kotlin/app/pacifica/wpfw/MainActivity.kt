...
class MainActivity: FlutterActivity() {
    ...
    companion object {
        private const val CHANNEL = "app.pacifica.wpfw/samsung_media_session"
    }
    ...
    private fun ensureAudioChannelNoBadge() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                ...
                val channelId = "com.wpfwfm.radio.audio" // must match AudioService.init config
                ...
                if (existing != null) {
                    ...
                    val ch = NotificationChannel(
                        ...
                        description = "WPFW Radio Audio Playback"
                        setShowBadge(false)
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        methodChannel?.setMethodCallHandler { call, result ->
            when (call.method) {
                "updateMetadata" -> {
                    val title = call.argument<String>("title") ?: "WPFW 89.3 FM"
                    val artist = call.argument<String>("artist") ?: "Jazz and Justice Radio"
    ...
    private fun setupMediaActionReceiver() {
        ...
        val filter = IntentFilter("wpfw_media_action")
